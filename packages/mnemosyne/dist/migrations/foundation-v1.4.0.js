...
export async function applyFoundationMigrationV14(memory) {
    // Apply core rules
    foundationMigrationV14.coreRules.forEach((rule) => {
    ...
    memory.currentFoundation = { version: foundationMigrationV14.version, timestamp: new Date().toISOString() };
