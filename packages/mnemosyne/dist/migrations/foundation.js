 ...
 */
export const foundationMigrationV1 = {
    version: "1.0.0",
 ...
 */
export const foundationMigrationV1_2 = {
    version: "1.2.0",
 ...
 */
export const foundationMigrationV1_4_1 = {
    version: "1.4.1",
 ...
 */
export async function applyFoundationMigration(memory, migration) {
    ...
    const migrationId = memory.logClaim(`Foundation migration ${migration.version} applied successfully`, {
    ...
    memory.verifyClaim(await migrationId, true, `Migration applied: ${migration.coreRules.length} rules, ${migration.essentialPatterns.length} patterns, ${migration.safetyConstraints.length} constraints`);
}
/**
