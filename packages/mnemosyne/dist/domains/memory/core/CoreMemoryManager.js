 ...
 */
import { BaseManager } from '../../../core/base/index';
/**
 * Core memory manager implementing domain-specific memory operations
 */
export class CoreMemoryManager extends BaseManager {
    memoryConfig;
    persistenceLayer;
    vectorStore;
    multiTierMemory;
    ...
    async get(id) {
        ...
        try {
            return await this.withTiming('get_operation', async () => {
                ...
                const persistedResult = await this.persistenceLayer.get(id);
                if (persistedResult) {
    ...
    async create(data) {
        ...
        try {
            return await this.withTiming('create_operation', async () => {
                // Validate input data
    ...
    async update(id, data) {
        ...
        try {
            return await this.withTiming('update_operation', async () => {
                // Get existing item
    ...
    async delete(id) {
        ...
        try {
            return await this.withTiming('delete_operation', async () => {
                let success = true;
    ...
    async list(filter) {
        ...
        try {
            return await this.withTiming('list_operation', async () => {
    ...
    async searchSimilar(query, options = {}) {
        ...
        try {
            return await this.withTiming('search_operation', async () => {
