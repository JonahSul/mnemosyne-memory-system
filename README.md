...
- Engineers & integrators: docs/ (engineer-facing docs), src/ code, types.ts for API types, and semantic examples in the repo root.
- Operators & SREs: docs/VENDOR_DEPLOYMENT.md for vendor-specific deploy guidance (Azure Functions + others), DEPLOYMENT.md, docker-compose.dev.yml and wrangler.jsonc.
- Architects & researchers: migrations/, copilot-notes/, and tests/ for experiments and design notes.
...
- Engineers: start at docs/README_ENGINEER.md (link in docs/) and the src/ tree. Example scripts and demos live in the repo root.
- Operators: see docs/VENDOR_DEPLOYMENT.md and DEPLOYMENT.md for production guidance and operational caveats.
