...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/_internal/utils.mjs
// @__NO_SIDE_EFFECTS__
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/perf_hooks.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/mock/noop.mjs
var noop_default;
var init_noop = __esm({
  "../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/mock/noop.mjs"() {
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/console.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/hrtime.mjs
var hrtime;
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/write-stream.mjs
var WriteStream;
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/read-stream.mjs
var ReadStream;
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/tty.mjs
var init_tty = __esm({
  "../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/tty.mjs"() {
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/node-version.mjs
var NODE_VERSION;
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/process.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../../.nvm/versions/node/v22.17.0/lib/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
var MemoryNotFoundError, CoreMemoryManager;
var init_core_memory = __esm({
  "src/modules/core-memory.ts"() {
    "use strict";
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    ...
    CoreMemoryManager = class {
      static {
        __name(this, "CoreMemoryManager");
      }
      ...
      getUnverifiedClaims(includeTestingData = false) {
        const unverified = Array.from(this.memories.values()).filter(
          (memory) => memory.type === "claim" && memory.status === "pending"
        );
      ...
      async searchMemory(query, includeTestingData = false) {
        ...
        const results = Array.from(this.memories.values()).filter(
          (memory) => memory.content.toLowerCase().includes(lowerQuery) || memory.context && JSON.stringify(memory.context).toLowerCase().includes(lowerQuery)
        );
    ...
    BehavioralRuleManager = class {
      ...
      getFoundationRules() {
        return Array.from(this.rules.values()).filter(
          (rule) => ["no-unverified-claims", "systematic-approach", "consult-memory-before-response"].includes(rule.id)
        );
      }
...
// src/modules/shared-prewarming.ts
var SharedPrewarmingService, sharedPrewarming;
var init_shared_prewarming = __esm({
  "src/modules/shared-prewarming.ts"() {
    "use strict";
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    SharedPrewarmingService = class {
      static {
        __name(this, "SharedPrewarmingService");
      }
      prewarmingAttempts = [];
      effectivenessRecords = [];
      createSessionPrewarmingStrategy(sessionContext) {
        const userQueries = sessionContext.userQueries || [];
        const identifiedDomain = sessionContext.identifiedDomain || "";
      ...
      recordPrewarmingEffectiveness(attempt) {
        const record = {
          ...
          timestamp: (/* @__PURE__ */ new Date()).toISOString(),
          successRate: attempt.success || 0.5,
          context: attempt,
      ...
      createModuleSpecificStrategy(moduleName, sessionContext) {
    ...
    sharedPrewarming = new SharedPrewarmingService();
  }
});
  ...
  "src/modules/prewarming-strategy.ts"() {
    ...
    PrewarmingManager = class {
      ...
      getAdaptedPrewarmingStrategy() {
        ...
        const successfulAttempts = history.filter((a) => a.success === true);
        const successRate = history.length > 0 ? successfulAttempts.length / history.length : 0.9;
  ...
  "src/modules/context-query.ts"() {
    ...
    ContextQueryManager = class {
      ...
      async storeContext(context2) {
        ...
        this.contexts.set(contextId, context2);
        return contextId;
      }
      ...
      // Private helper methods
      performSemanticSearch(query, limit, threshold, includeTestingData = false) {
      ...
      performTieredSearch(query, tierPreference, limit, threshold, includeTestingData = false) {
        const queryEmbeddings = this.generateEmbeddings(query);
        const results = [];
        for (const [id, entry] of this.tieredKnowledge) {
          ...
          if (similarity >= threshold) {
            ...
            const adjustedSimilarity = Math.min(1, similarity * tierBoost);
            results.push({
              id,
              content: entry.content,
...
var init_memory_tool = __esm({
  "src/memory-tool.ts"() {
    ...
    MnemosyneMemorySystem = class {
      ...
      storeMemory(entry, testing) {
        if (testing) {
          entry.context = { ...entry.context || {}, testing: true };
        }
        this.coreMemory.storeMemory(entry, testing);
      }
      searchMemory(query, includeTestingData = false) {
        return this.coreMemory.searchMemory(query, includeTestingData);
      }
      getMemoryStats() {
        return this.coreMemory.getMemoryStats();
      }
      exportMemory(includeTestingData = false) {
        return this.coreMemory.exportMemory(includeTestingData);
      }
      // =============================================================================
...
// src/multi-tier-memory.ts
var DEFAULT_TIER_CONFIG, MultiTierMemorySystem;
var init_multi_tier_memory = __esm({
  "src/multi-tier-memory.ts"() {
    "use strict";
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    ...
    DEFAULT_TIER_CONFIG = {
      axiom: {
        name: "axiom-tier",
        maxItems: 100,
        // Reasonable limit for key axioms
        retentionHours: Infinity,
        // Never expire
        accessThreshold: 0,
        // No promotion needed
        pruningStrategy: "importance"
        // Only remove least important if at capacity
      },
      long: {
        name: "long-term",
        maxItems: 1e3,
        ...
        // 1 year retention
        accessThreshold: 0,
        // No promotion (axiom is top tier)
        pruningStrategy: "importance"
    ...
    MultiTierMemorySystem = class {
      static {
        __name(this, "MultiTierMemorySystem");
      }
      axiomTier = /* @__PURE__ */ new Map();
      longTerm = /* @__PURE__ */ new Map();
      intermediateTerm = /* @__PURE__ */ new Map();
      shortTerm = /* @__PURE__ */ new Map();
      config;
      constructor(config2 = DEFAULT_TIER_CONFIG) {
        this.config = config2;
      }
      /**
      ...
      async storeKnowledge(knowledge) {
        ...
        const item = {
          ...
          metadata: {
            ...knowledge.metadata || {},
            testing: knowledge.testing || false
            // Add testing flag to metadata
          },
          tags: knowledge.tags || [],
          timestamp,
          tier: targetTier,
      ...
      calculateAdaptiveThreshold(options = {}) {
        ...
        const tierMultiplier = tierPreference === "long" || tierPreference === "axiom" ? 1.1 : tierPreference === "short" ? 0.9 : 1;
        let resultCountMultiplier = 1;
        if (expectedResultCount) {
          if (expectedResultCount > 10) {
            resultCountMultiplier = 0.9;
          } else if (expectedResultCount < 3) {
            resultCountMultiplier = 1.1;
          }
        }
        const memoryLoadMultiplier = currentMemoryLoad ? 1 + currentMemoryLoad * 0.3 : 1;
        const adaptiveThreshold = baseThreshold * complexityMultiplier * tierMultiplier * resultCountMultiplier * memoryLoadMultiplier;
      ...
      async pruneIfNecessary(tier) {
        ...
        const config2 = this.config[tier];
        if (!config2) return;
        if (config2.retentionHours === Infinity) {
          if (tierMap.size <= config2.maxItems) {
            return;
          }
        } else {
        ...
        const itemsToRemove = tierMap.size - config2.maxItems;
        const sortedItems = Array.from(tierMap.values()).sort((a, b) => {
          switch (config2.pruningStrategy) {
            case "lru":
      ...
      async pruneExpiredItems(tier) {
        ...
        const now = Date.now();
        if (!config2) return;
        const retentionMs = config2.retentionHours * 60 * 60 * 1e3;
        if (config2.retentionHours === Infinity) {
          return;
        }
        const expiredItems = [];
      ...
      shouldSpareFromExpiration(item, tier) {
        ...
        const recentAccessMs = 24 * 60 * 60 * 1e3;
      ...
      calculateRetentionProbability(item, tier) {
        if (tier === "axiom") return 1;
        const now = Date.now();
        const itemAge = now - new Date(item.timestamp).getTime();
        const ageInHours = itemAge / (60 * 60 * 1e3);
        const decayConstant = tier === "long" ? 2e3 : tier === "intermediate" ? 50 : 5;
        let baseProbability = Math.exp(-ageInHours / decayConstant);
        const importanceModifier = 0.5 + item.importance * 0.5;
        baseProbability *= importanceModifier;
        const accessModifier = Math.min(1 + item.accessCount * 0.1, 2);
        baseProbability *= accessModifier;
        const timeSinceAccess = now - new Date(item.lastAccessed).getTime();
        const recencyHours = timeSinceAccess / (60 * 60 * 1e3);
        const recencyModifier = recencyHours < 24 ? 1.2 : 1;
        baseProbability *= recencyModifier;
        const semanticModifier = 0.8 + item.semanticWeight * 0.4;
      ...
      calculateSignificanceWeight(content, importance) {
        ...
        const lengthBoost = Math.min(contentLength / 1e3, 0.3);
        weight += lengthBoost;
        const importanceKeywords = ["critical", "important", "error", "bug", "security", "performance", "urgent"];
        const keywordMatches = importanceKeywords.filter(
          (keyword) => content.toLowerCase().includes(keyword)
        ).length;
        const keywordBoost = Math.min(keywordMatches * 0.1, 0.2);
        weight += keywordBoost;
      ...
      async calculateSemanticWeight(content, embedding) {
        ...
        return Math.min(semanticWeight, 1);
      }
      ...
      getTiersToSearch(preference) {
        switch (preference) {
          case "axiom":
            return [["axiom", this.axiomTier]];
          case "long":
            return [["long", this.longTerm]];
          case "intermediate":
            return [["intermediate", this.intermediateTerm]];
          case "short":
            return [["short", this.shortTerm]];
          case "all":
          default:
            return [
      ...
      getTierBoost(tier) {
        switch (tier) {
          case "axiom":
            return 100;
          // Massive boost - axioms always surface first
          case "long":
            return 1.2;
          case "intermediate":
            return 1.1;
      ...
      getMemoryStats(includeTestingData = false) {
        ...
        const countItems = /* @__PURE__ */ __name((tierMap) => {
          if (includeTestingData) {
          ...
          return { count: count3, testingCount };
        }, "countItems");
        if (this.config.axiom) {
          const { count: count3, testingCount } = countItems(this.axiomTier);
          const stats = {
            count: includeTestingData ? this.axiomTier.size : count3,
            capacity: this.config.axiom.maxItems,
            utilizationPercent: (includeTestingData ? this.axiomTier.size : count3) / this.config.axiom.maxItems * 100
          };
        ...
        const totalTestingItems = includeTestingData ? 0 : (result.axiom?.testingItems || 0) + long.testingItems + intermediate.testingItems + short.testingItems;
        result.total = {
          count: totalCount,
      ...
      getForgettingCurveAnalytics() {
        ...
        for (const [tierName, tierMap] of tiersToAnalyze) {
          ...
          analytics.averageRetention[tierName] = probabilities.length > 0 ? probabilities.reduce((sum, p) => sum + p, 0) / probabilities.length : 0;
      ...
      getSparedItemsCount() {
        ...
        for (const [tierName, tierMap] of [
          ...
          const config2 = this.config[tierName];
          if (!config2) continue;
          const retentionMs = config2.retentionHours * 60 * 60 * 1e3;
          if (config2.retentionHours === Infinity) {
            continue;
      ...
      getItemsNearExpiration() {
        ...
        for (const [tierName, tierMap] of [
          ...
          const nearExpirationThreshold = retentionMs * 0.9;
          for (const item of tierMap.values()) {
            const itemAge = now - new Date(item.timestamp).getTime();
...
__export(registry_exports, {
  ...
  registerMemoryTools: () => registerMemoryTools
});
...
var memoryInstance, vectorStoreInstance, multiTierMemoryInstance, memoryTools;
    ...
    memoryTools = [
      {
        ...
        schema: {
          claim: external_exports.string().describe("The exact claim being made (e.g., 'The deployment was successful', 'The bug is in line 42', 'User wants feature X')"),
          confidence: external_exports.enum(["low", "medium", "high"]).optional().describe("Agent's confidence level in this claim - use 'low' for assumptions, 'high' for verified facts"),
          source: external_exports.string().optional().describe("Source of information supporting this claim (e.g., 'file analysis', 'user statement', 'documentation')"),
          context: external_exports.record(external_exports.unknown()).optional().describe("Additional context including reasoning, assumptions, or supporting data that led to this claim")
        },
      ...
      },
      {
        ...
        schema: {
          claimId: external_exports.string().describe("The unique ID of the claim to verify (obtained from memory_log_claim)"),
          success: external_exports.boolean().describe("Whether the claim was verified as TRUE (confirmed by evidence) or FALSE (refuted by evidence)"),
          evidence: external_exports.string().describe("Concrete evidence supporting or refuting the claim - be specific about what was observed, tested, or confirmed"),
          notes: external_exports.string().optional().describe("Additional notes about the verification process, lessons learned, or implications")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          try {
            const memory = getMnemosyneMemoryInstance();
            ...
            if (error3 instanceof MemoryNotFoundError) {
              return {
                content: [{
                  type: "text",
      ...
      },
      {
        ...
        schema: {
          focusArea: external_exports.enum(["claims", "violations", "patterns", "all"]).optional().describe("Focus the status check on specific behavioral area"),
          includeHistory: external_exports.string().optional().describe("Whether to include detailed historical behavioral data and patterns")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const memory = getMnemosyneMemoryInstance();
      ...
      },
      {
        ...
        schema: {
          autoCorrect: external_exports.boolean().optional().describe("Whether to automatically attempt corrections when failures are detected"),
          includeRestorePlan: external_exports.boolean().optional().describe("Include detailed plan for memory restoration if failures detected"),
          emergencyMode: external_exports.boolean().optional().describe("Run in emergency mode with aggressive sanity checks")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          ...
          try {
            ...
            try {
              ...
              sanityResults.failures.push(`Vector store search failed: ${error3 instanceof Error ? error3.message : "Unknown error"}`);
            ...
            try {
              ...
              sanityResults.failures.push(`Storage/retrieval test failed: ${error3 instanceof Error ? error3.message : "Unknown error"}`);
              if (sanityResults.overallHealth === "healthy") sanityResults.overallHealth = "critical";
            }
            if (params.emergencyMode) {
              const recentClaims = Object.values(exportData?.claims || {}).filter((claim) => {
            ...
            if (params.autoCorrect && sanityResults.failures.length > 0) {
              if (sanityResults.failures.some((f) => f.includes("Foundation rules missing"))) {
                try {
                  ...
                  sanityResults.autoCorrections.push(`Foundation restoration failed: ${error3 instanceof Error ? error3.message : "Unknown error"}`);
                }
              }
            }
            const totalTime = Math.round((performance.now() - startTime) * 1e3) / 1e3;
            return {
              content: [{
                type: "text",
...
\u{1F6A8} FAILURES (${sanityResults.failures.length}):
...
\u{1F527} AUTO-CORRECTIONS:
${sanityResults.autoCorrections.map((a) => `  \u2022 ${a}`).join("\n")}` : ""}

SYSTEM CHECKS:
${Object.entries(sanityResults.checks).map(
                  ([check, result]) => `  ${check}: ${JSON.stringify(result)}`
                ).join("\n")}
...
`
            ...
            return {
              content: [{
                type: "text",
                text: `Sanity check failed catastrophically: ${error3 instanceof Error ? error3.message : "Unknown error"}`
              }],
              isError: true
            };
          }
      ...
      },
      {
        ...
        schema: {
          ruleId: external_exports.string().optional().describe("View details for a specific foundation rule by ID"),
          includeExamples: external_exports.string().optional().describe("Include practical examples of rule application"),
          checkCompliance: external_exports.string().optional().describe("Include current compliance status for each rule")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const memory = getMnemosyneMemoryInstance();
          const foundation = memory.getFoundationInfo();
      ...
      },
      {
        ...
        schema: {
          ruleId: external_exports.string().describe("The ID of the behavioral rule that was violated (from foundation rules or custom rules)"),
          context: external_exports.string().describe("Detailed description of how and when the violation occurred, including specific actions taken"),
          severity: external_exports.enum(["minor", "moderate", "major", "critical"]).optional().describe("Severity assessment of the violation"),
          correctionPlan: external_exports.string().optional().describe("Specific plan for correcting the violation and preventing recurrence")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const memory = getMnemosyneMemoryInstance();
      ...
      },
      {
        ...
        schema: {
          migration: external_exports.record(external_exports.unknown()).describe("Complete foundation migration object with rules, patterns, and metadata"),
          options: external_exports.record(external_exports.unknown()).optional().describe("Update options and behavior controls")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const memory = getMnemosyneMemoryInstance();
          try {
      ...
      },
      {
        ...
        schema: {
          format: external_exports.enum(["summary", "detailed", "raw"]).optional().describe("Export format: 'summary' for overview, 'detailed' for analysis, 'raw' for complete data"),
          filterType: external_exports.enum(["claims", "violations", "rules", "all"]).optional().describe("Filter export to specific data types"),
          includeMetadata: external_exports.string().optional().describe("Whether to include system metadata and timestamps")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const memory = getMnemosyneMemoryInstance();
          const exportData = await memory.exportState();
      ...
      // Vector Knowledge Tools for RAG-based working memory
      {
        ...
        schema: {
          content: external_exports.string().describe("The knowledge content to store (text, facts, procedures, etc.)"),
          metadata: external_exports.record(external_exports.unknown()).optional().describe("Structured metadata about the knowledge (type, domain, importance, etc.)"),
          tags: external_exports.array(external_exports.string()).optional().describe("Tags for categorization and filtering")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const startTime = performance.now();
          const vectorStore = getVectorStoreInstance();
          ...
          try {
            ...
            const validationResults = await vectorStore.searchSimilar(params.content, {
              limit: 1,
              threshold: 0.9
              // Slightly lower threshold to account for mock embedding limitations
            });
            const validationTime = performance.now();
            const isValidated = validationResults.some(
              (item) => item.content === params.content && item.similarity >= 0.9
            );
            const metrics = {
              storeLatency: Math.round((storeTime - startTime) * 1e3) / 1e3,
              // ms
              validationLatency: Math.round((validationTime - storeTime) * 1e3) / 1e3,
              // ms
              totalLatency: Math.round((validationTime - startTime) * 1e3) / 1e3,
              // ms
            ...
            if (isValidated) {
              ...
              return {
                ...
                isError: false
                // Not a hard error since storage succeeded
              };
            }
          } catch (error3) {
            const errorTime = performance.now();
            const errorLatency = Math.round((errorTime - startTime) * 1e3) / 1e3;
            return {
              content: [{
                type: "text",
                text: `Storage failed after ${errorLatency}ms: ${error3 instanceof Error ? error3.message : "Unknown error occurred"}`
              }],
              isError: true
            };
          }
      ...
      },
      {
        ...
        schema: {
          query: external_exports.string().describe("The search query or question to find related knowledge"),
          limit: external_exports.number().optional().describe("Maximum number of results to return (default: 8)"),
          threshold: external_exports.number().optional().describe("Minimum similarity threshold for results (0-1, default: 0.05 for inclusive search)")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const vectorStore = getVectorStoreInstance();
          ...
          const detailsText = results.map(
            (result, index) => `${index + 1}. [${(result.similarity * 100).toFixed(1)}%] ${result.content}`
          ).join("\n");
          return {
            content: [{
              type: "text",
...
${detailsText}`
      ...
      // Multi-Tier Memory Tools for hierarchical knowledge management
      {
        ...
        schema: {
          content: external_exports.string().describe("The knowledge content to store"),
          importance: external_exports.number().optional().describe("Importance score 0-1 (determines tier placement: <0.3=short, 0.3-0.7=intermediate, >0.7=long)"),
          targetTier: external_exports.enum(["short", "intermediate", "long"]).optional().describe("Override automatic tier placement"),
          metadata: external_exports.record(external_exports.unknown()).optional().describe("Additional metadata"),
      ...
      },
      {
        ...
        schema: {
          ...
          tierPreference: external_exports.enum(["short", "intermediate", "long", "all"]).optional().describe("Which tier(s) to search (default: all)"),
          limit: external_exports.number().optional().describe("Maximum results (default: 8)"),
          threshold: external_exports.number().optional().describe("Similarity threshold (default: 0.05 for inclusive search)")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          const multiTierMemory = getMultiTierMemoryInstance();
          ...
          const detailsText = results.map(
            (result, index) => `${index + 1}. [${result.tier.toUpperCase()}] ${(result.similarity * 100).toFixed(1)}% - ${result.content}`
          ).join("\n");
          return {
            content: [{
              type: "text",
...
${detailsText}`
      ...
      },
      {
        ...
        schema: {
          workloadType: external_exports.enum(["exploration", "precision", "recall", "balanced", "debugging"]).describe("Type of workload: 'exploration' (very low threshold), 'precision' (high threshold), 'recall' (low threshold), 'balanced' (moderate), 'debugging' (adaptive)"),
          contextComplexity: external_exports.enum(["simple", "moderate", "complex"]).optional().describe("Complexity of the search context (affects threshold adjustment)"),
          expectedResultCount: external_exports.number().optional().describe("Expected number of relevant results (influences threshold tuning)"),
          customThreshold: external_exports.number().optional().describe("Override with specific threshold (0-1)")
        },
        handler: /* @__PURE__ */ __name(async (params) => {
          let recommendedThreshold;
          let description;
          if (params.customThreshold !== void 0) {
          ...
          return {
            content: [{
              type: "text",
              text: `\u{1F3AF} **Search Threshold Tuning**
...
\u2022 0.30+: Very selective (exact matches only)`
    ...
    __name(registerMemoryTools, "registerMemoryTools");
  }
});
  ...
  async handleMcpRequest(request, corsHeaders) {
    ...
    try {
      ...
      if (body.method === "tools/list") {
        const { memoryTools: memoryTools2 } = await Promise.resolve().then(() => (init_registry(), registry_exports));
        return new Response(JSON.stringify({
          jsonrpc: "2.0",
          id: body.id,
          result: {
            tools: memoryTools2.map((tool) => ({
              name: tool.name,
      ...
      if (body.method === "tools/call") {
        ...
        const { memoryTools: memoryTools2 } = await Promise.resolve().then(() => (init_registry(), registry_exports));
        const tool = memoryTools2.find((t) => t.name === toolName);
        if (!tool) {
          return new Response(JSON.stringify({
            jsonrpc: "2.0",
            id: body.id,
            error: {
              ...
              data: {
                availableTools: memoryTools2.map((t) => t.name)
              }
            }
          }), {
            status: 404,
